...
// import { ICONS, UPDATE_PROPS, X, Y, V } from "./const";
// import {
//   getMin,
//   getAvg,
//   getMax,
...
// import { ConfigEntry } from "home-assistant-frontend-types/frontend/src/data/config_entries";
...
//         @click=${(e) =>
//           this.handlePopup(e, config.tap_action.entity || this.entity[0])}
//       >
...
//               (entityConfig, i) => (i > 0 && this.renderState(i)) || ""
//             )}
//           </div>
...
//             ? `color: ${this.computeColor(value, entity)}`
//             : ""}
//         >
//           ${entityConfig.show_indicator
//             ? this.renderIndicator(value, entity)
//             : ""}
//           <span class="state__value ellipsis">
//             ${this.computeState(value)}
//           </span>
//           <span class="state__uom ellipsis"> ${this.computeUom(entity)} </span>
...
//                   entity.index,
//                   -1,
//                   this.getEntityState(entity.index),
//                   "Current"
//                 )}
...
//         style="animation-delay: ${this.config.animate ? `${i * 0.5}s` : "0s"}"
//         fill='none'
//         stroke-dasharray=${this.length[i] || "none"} stroke-dashoffset=${
//       this.length[i] || "none"
//     }
//         stroke=${"white"}
...
//         ?inactive=${
//           this.tooltip.entity !== undefined && this.tooltip.entity !== i
//         }
//         ?init=${this.length[i]}
...
//           >${this.computeState(this.boundSecondary[1])}</span
//         >
//         <span class="label--min"
//           >${this.computeState(this.boundSecondary[0])}</span
//         >
//       </div>
//     `;
//   }
